...
import com.sep.treksphere.common.security.JwtAuthenticationEntryPoint;
import com.sep.treksphere.common.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        log.info("Configuring SecurityFilterChain with JWT, CORS, and Stateless Session");
