...
public class MessageConstant {
    ...
    public static final String UNAUTHORIZED_SOS_ALERT = "Bạn không phải thành viên đang hoạt động của nhóm để phát/xem tín hiệu SOS này";
    public static final String SESSION_FOR_SOS_NOT_ACTIVE = "Chuyến đi chưa hoặc không còn đang diễn ra nên không thể phát tín hiệu SOS";
    ...
    public static final String SOS_IDEMPOTENCY_KEY_REQUIRED = "idempotencyKey không được để trống";
    public static final String SOS_IDEMPOTENCY_KEY_TOO_LONG = "idempotencyKey tối đa 255 ký tự";
    ...
    public static final String SCHEDULE_DATES_NOT_MATCH_TOUR_DURATION = "Lịch khởi hành phải kéo dài đúng số ngày Tour đã thiết lập";
    public static final String SCHEDULE_DUPLICATE_DATES = "Đã có lịch khởi hành khác với đúng ngày đi và ngày về này";
