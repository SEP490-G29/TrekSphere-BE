...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Request tạo điểm dừng checkpoint trong hành trình Custom Journey")
public class CustomJourneyCheckpointCreateRequest {
    ...
    @NotBlank(message = MessageConstant.CHECKPOINT_TITLE_REQUIRED)
