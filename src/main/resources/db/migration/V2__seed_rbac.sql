...
INSERT INTO role (role_id, role_name, description) VALUES
    ...
    ('6162afa8-8a00-4477-9e5e-5ce2ddb3258d', 'VENDOR', 'Tour vendor owner');
...
INSERT INTO permission (permission_id, resource, action, description) VALUES
    ...
    ('a1000000-0000-4000-8000-000000000010', 'TOUR', 'HIDE_UNHIDE', 'Admin ẩn/mở lại Tour khi kiểm duyệt nội dung'),
    ('a1000000-0000-4000-8000-000000000011', 'MATCHING_GROUP', 'CREATE', 'Tạo nhóm ghép bạn đồng hành'),
    ('a1000000-0000-4000-8000-000000000012', 'MATCHING_GROUP', 'MANAGE_OWN', 'Chủ nhóm quản lý nhóm ghép của mình'),
    ...
    ('a1000000-0000-4000-8000-000000000015', 'GROUP_TRIP', 'MANAGE', 'Quản lý không gian chuyến đi: lịch trình, chi phí, checklist, moments'),
...
WHERE (resource, action) IN (
    ...
    ('MATCHING_GROUP', 'CREATE'), ('MATCHING_GROUP', 'MANAGE_OWN'),
    ('MATCHING_GROUP', 'PARTICIPATE'), ('MATCHING_GROUP', 'VOTE'),
...
INSERT INTO users (
    user_id, email, full_name, password_hash, phone,
    status, email_verified, provider,
    preferred_areas, skills, trust_score, trust_review_count,
...
INSERT INTO user_role (user_id, role_id) VALUES
    ('b70fbe4a-6199-416a-aae1-536b8c497b3e', 'a85194bd-7aa5-4d85-9400-1d145000675c');
