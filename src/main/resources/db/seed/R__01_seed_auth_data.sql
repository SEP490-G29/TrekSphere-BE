...
SELECT '11111111-1111-1111-1111-111111111111'::uuid, roleid FROM role WHERE role_name = 'ADMIN' UNION ALL
SELECT '22222222-2222-2222-2222-222222222221'::uuid, roleid FROM role WHERE role_name = 'TREKKER' UNION ALL
SELECT '22222222-2222-2222-2222-222222222222'::uuid, roleid FROM role WHERE role_name = 'TREKKER' UNION ALL
SELECT '33333333-3333-3333-3333-333333333331'::uuid, roleid FROM role WHERE role_name = 'VENDOR_MANAGER' UNION ALL
SELECT '33333333-3333-3333-3333-333333333332'::uuid, roleid FROM role WHERE role_name = 'VENDOR_MANAGER' UNION ALL
SELECT '44444444-4444-4444-4444-444444444441'::uuid, roleid FROM role WHERE role_name = 'VENDOR_STAFF' UNION ALL
SELECT '55555555-5555-5555-5555-555555555551'::uuid, roleid FROM role WHERE role_name = 'COORDINATOR' UNION ALL
SELECT '66666666-6666-6666-6666-666666666661'::uuid, roleid FROM role WHERE role_name = 'PORTER' UNION ALL
SELECT '66666666-6666-6666-6666-666666666662'::uuid, roleid FROM role WHERE role_name = 'PORTER'
