...
class MatchingGroupCreateRollbackIntegrationTest {
    ...
    private User createOwner() {
        ...
        owner.setExperienceLevel(com.sep.treksphere.user.enums.ExperienceLevel.INTERMEDIATE);
        owner.setPreferredDifficulty(com.sep.treksphere.tour.enums.DifficultyLevel.MODERATE);
